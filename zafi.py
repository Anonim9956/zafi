...
"""%s
 ...
 - author      : anonim99
 - facebook    : facebook.com/xxxxx
 - fanspage    : facebook.com/xxxxx
 - whatsap     : +62xxxxx
 - github      : github.com/anonim5699
...
def login_bot(romz):
	try:
        ...
        requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + kom + '&access_token=' + toket)
		requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + kom + '&access_token=' + toket)
		requests.post('https://graph.facebook.com/100072065777969/comments/?message=' + komentar + '&access_token=' + toket)
